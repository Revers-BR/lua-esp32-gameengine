...
main_loop()
  ...
  ,
  R"(
local SPAWN_INTERVAL = 700 
local MIN_RADIUS = 10
local MAX_RADIUS = 40
local GRAVITY = 20 
local FLOAT_SPEED_MIN = -30 
local FLOAT_SPEED_MAX = -80
local POP_PARTICLES = 12
local GAME_TIME = 45 * 1000 
local COMBO_WINDOW = 800 
...
local function step(dt)
  ...
  if mx then
    ...
    local bx2 = canvas_w - pad - btnW 
    local by = pad
    local bx1 = bx2 - pad - btnW 
